...
class VentasControlador{
    ...
    static public function ctrRegistrarVenta($datos,$nro_boleta,$subtotal,$igv,$total_venta,$descripcion_venta){
        
        $productos = VentasModelo::mdlRegistrarVenta($datos,$nro_boleta,$subtotal,$igv,$total_venta,$descripcion_venta);

...
class VentasModelo{
    ...
    static public function mdlRegistrarVenta($datos,$nro_boleta,$subtotal,$igv,$total_venta,$descripcion_venta){

        $stmt = Conexion::conectar()->prepare("INSERT INTO venta_cabecera(nro_boleta,descripcion,subtotal,igv,total_venta)         
                                                VALUES(:nro_boleta,:descripcion,:subtotal,:igv,:total_venta)");
